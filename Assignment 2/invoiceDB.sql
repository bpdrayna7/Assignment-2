...
INSERT INTO Invoice (customerId,personId,invoiceDate) VALUES ((SELECT customerId FROM Customer WHERE customerCode="C004"),(SELECT personId FROM Person WHERE personCode="2yyu"),"2016-05-05"); #For testing query #11, personCode changed to '2yyu'
...
INSERT INTO InvoiceProduct (invoiceId,productId,quantity,agreementId) VALUES ((SELECT invoiceId FROM Invoice WHERE invoiceDate="2018-03-03"),(SELECT productId FROM Product WHERE productCode="tt8y"),12, 1); #For testing query #15
