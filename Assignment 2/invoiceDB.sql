...
#Insert Invoices
INSERT INTO Invoice (invoiceCode,customerId,personId,invoiceDate) VALUES ("I001",(SELECT customerId FROM Customer WHERE customerCode="C001"),(SELECT personId FROM Person WHERE personCode="77s7"),"2018-03-03");
INSERT INTO Invoice (invoiceCode,customerId,personId,invoiceDate) VALUES ("I002",(SELECT customerId FROM Customer WHERE customerCode="C002"),(SELECT personId FROM Person WHERE personCode="123s"),"2015-12-13");
INSERT INTO Invoice (invoiceCode,customerId,personId,invoiceDate) VALUES ("I003",(SELECT customerId FROM Customer WHERE customerCode="C003"),(SELECT personId FROM Person WHERE personCode="2yyu"),"2019-01-01");
INSERT INTO Invoice (invoiceCode,customerId,personId,invoiceDate) VALUES ("I004",(SELECT customerId FROM Customer WHERE customerCode="C004"),(SELECT personId FROM Person WHERE personCode="2yyu"),"2016-05-05"); #For testing query #11, personCode changed to '2yyu'
INSERT INTO Invoice (invoiceCode,customerId,personId,invoiceDate) VALUES ("I005",(SELECT customerId FROM Customer WHERE customerCode="C005"),(SELECT personId FROM Person WHERE personCode="8890"),"2019-09-09");
